...
<div id="root">
    ...
    <div class="container" style="margin-top: 130px;">
        ...
        <div class="row" style="margin-top: 50px;">
            <div class="col-6">
                <section>
                    <form:form name="myForm" method="post" action="" modelAttribute="device" onsubmit="return validDevice()">
                        <div class="mb-3 ">
                        ...
                        <div class="mb-3">
                            ...
                            <form:input type="text" class="form-control" name="location" path="location"/>
                        ...
                        <button  class="btn btn-warning" id="btn-add" onclick="location.href ='list-device'">Cancel</button>
                    </form:form>
                </section>
            </div>
            <div class="col-6">
